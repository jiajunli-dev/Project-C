  ...
  return (
    <form className="w-3/5 border-2 p-4 dark:bg-[#121212]">
      ...
      <h1 className="text-black text-lg font-bold mb-8 dark:text-white">
        Check all of the information you have entered and make sure it is
        correct!
      </h1>

      <div className="flex flex-col gap-4 text-md text-black m-4">
        <h3 className="dark:text-white">
          <span className="font-semibold dark:text-white">Description</span> :
          <br /> {ticketDescription}
        </h3>
        <h3>
          ...
          {ticketTriedSolutions &&
            ticketTriedSolutions.map((solution) => (
              <p className="text-md dark:text-white" key={solution}>
                {solution},<br />
              </p>
            ))}
        </h3>
