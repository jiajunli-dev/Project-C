...
const FormPageTwo = ({setTicketTriedSolutions, ticketTriedSolutions, setCurrForm, currForm, maxForm}:FormPageTwoProps) => {
  return (
    ...
    <div className="flex justify-evenly gap-2 ">
        ...
        <button 
                onClick={() => {
                    if(currForm === maxForm || ticketTriedSolutions === "") return
