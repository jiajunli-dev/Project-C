...
\       <Header />
        ...
        <div className="w-full h-full flex flex-col justify-center items-center">
           ...
           <div className="flex w-3/5 justify-between border-x-2 border-t-2  rounded-t-lg p-1 items-center  ">
                <h1 className="text-lg  font-semibold text-blue-500">Create ticket</h1>
                {currForm === maxForm ? 
                    <div className="flex gap-2">
                        <button 
                            onClick={() => currForm > 0 && setCurrForm(currForm - 1)}
                                type="button" className="flex justify-center rounded-none text-white bg-white border-2 hover:text-black hover:bg-white hover:border-2 hover:border-black focus:outline-none focus:ring-black font-medium text-sm sm:w-auto p-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button 
                            onClick={() => {
                                ...
                                type="button" className=" flex justify-center  rounded-none text-white border-2 bg-white hover:text-black hover:bg-white hover:border-2 hover:border-black focus:outline-none focus:ring-black font-medium text-sm sm:w-auto p-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
            ...
            {/* Form 1  */}
            {currForm === 0 && (
                <FormPageOne ticketDescription={ticketDescription} setTicketDescription={setTicketDescription} maxForm={maxForm} setCurrForm={setCurrForm} currForm={currForm} />
            )}
            ...
            {/* Form 4  */}
            {currForm === 3 && (
                <FormPageFour setTicketStatus={setTicketStatus} ticketStatus={ticketStatus} setCurrForm={setCurrForm} currForm={currForm} maxForm={maxForm} />
            )}

            {/* Form 5  */}
            {currForm === 4 && (
                <FormPageFive ticketAdditionalNotes={ticketAdditionalNotes} ticketDescription={ticketDescription} ticketTriedSolutions={ticketTriedSolutions}  ticketStatus={ticketStatus} setCurrForm={setCurrForm} currForm={currForm} maxForm={maxForm} />
            )}
                ...
                <div className="flex flex-col justify-center items-center mt-8">
                    ...
                    <button 
                            onClick={() => {
                                ...
                                type="button" className=" flex justify-center text-black w-full border-gray-300 rounded border-2 bg-white hover:text-black hover:bg-white hover:border-2 hover:border-black focus:outline-none focus:ring-black font-medium text-sm sm:w-auto p-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
